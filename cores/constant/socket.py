...
class SioEvent(Enum):
    ...
    TG_ACCOUNT_DIALOG_INFO_SYNC_SUCCESS = "tg_account_dialog_info_sync_success"  # 账户对话信息同步成功
    TG_ACCOUNT_DIALOG_INFO_SYNC_ERROR = "tg_account_dialog_info_sync_error"  # 账户对话信息同步失败
